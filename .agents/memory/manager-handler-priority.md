...
**How to apply:** Put explicit Manager commands in an earlier (lower-numbered) group and keep conversation-state handlers in a later group. Verify with a real Telegram message, not only plugin-load logs.