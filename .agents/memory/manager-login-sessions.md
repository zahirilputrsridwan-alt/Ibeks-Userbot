...
**How to apply:** Expire and clean up the state on success, failure, cancellation, timeout, or flood wait. Clear phone-code hashes and password/OTP variables after each attempt. Keep OTP and password input out of logs.